    ...
    def get(self):
        ...
        if filepaths:
            ...
            try:
                ...
                print(
                    'problem loading interpolated look up table (.ilut) files from:\n'+self.iLUTs_dir)
        else:
            ...
            try:
                ...
                for fpath in filepaths:
                    ...
                    if os.path.isfile(ilut_filepath):
                        print(
                            'iLUT file already exists (skipping interpolation): {}'.format(fname))
                    else:
                        ...
                        print('Interpolation took {:.2f} (secs) = '.format(
                            time.time()-t))
